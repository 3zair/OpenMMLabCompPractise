import os
import random
PATH_IMAGE = 'E:\\data\\dataset\\Glomeruli-dataset\\images'
...
train_file_list[:5]
test_file_list[:5]
os.mkdir('E:\\data\\dataset\\Glomeruli-dataset/splits')
with open('E:\\data\\dataset\\Glomeruli-dataset/splits/train.txt', 'w') as f:
    f.writelines(line.split('.')[0] + '\n' for line in train_file_list)
with open('E:\\data\\dataset\\Glomeruli-dataset/splits/val.txt', 'w') as f:
